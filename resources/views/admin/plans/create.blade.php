...
<form method="POST" action="{{ route('admin.plans.store') }}">
    ...
    <textarea name="description" id="description" required>{{ old('description') }}</textarea><br><br>
    ...
    <input type="number" name="duration_days" id="duration_days" value="{{ old('duration_days') }}" required><br><br>
